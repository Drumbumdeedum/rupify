...
import arg from 'arg';
import { getLatestVersion, AppGenerator } from '@blitzjs/generator';
import { r as readVersions, l as loadEnvConfig } from './index2.mjs';
import { r as runPrisma } from './run-prisma.mjs';
import { i as isInternalBlitzMonorepoDevelopment, a as getGlobalPkgManager } from './helpers.mjs';
...
const newApp = (argv) => __async(void 0, null, function* () {
  ...
  try {
    const latestBlitzVersion = (yield getLatestVersion("blitz")).value;
    ...
    const generatorOpts = {
      ...
      onPostInstall: () => __async(void 0, null, function* () {
        ...
        try {
          ...
          const result = yield runPrisma(["migrate", "dev", "--name", "Initial migration"], true);
          if (!result.success)
            throw new Error();
