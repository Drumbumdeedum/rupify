...
import { ClientPlugin, Simplify, UnionToIntersection, Ctx } from 'blitz';
...
declare type PluginsExports<TPlugins extends readonly ClientPlugin<object>[]> = Simplify<UnionToIntersection<{
...
} & Simplify<UnionToIntersection<{ [I in keyof TPlugins & number]: ReturnType<TPlugins[I]["exports"]>; }[number]>>;

declare const NoPageFlicker: () => JSX.Element;

export { AppProps, BlitzLayout, BlitzPage, BlitzProvider, BlitzProviderProps, ErrorBoundary, ErrorBoundaryProps, ErrorBoundaryPropsWithComponent, ErrorBoundaryPropsWithFallback, ErrorBoundaryPropsWithRender, ErrorComponent, ErrorFallbackProps, ErrorProps, NoPageFlicker, PluginsExports, RouterContext, extractQueryFromAsPath, extractRouterParams, setupBlitzClient, useErrorHandler, useParam, useParams, useRouterQuery, withErrorBoundary };
