...
var Array$1 = /*#__PURE__*/chevrotain.createToken({
  name: 'Array',
  pattern: /\[\]/,
  label: "'[]'"
});
...
var multiModeTokens = {
  modes: {
    ...
    block: /*#__PURE__*/[].concat(naTokens, [Attribute, ModelAttribute, FieldAttribute, Dot, QuestionMark, Array$1, LCurly, RCurly, LSquare, RSquare, LRound, RRound, Comma, Colon, Equals, True, False, Null, StringLiteral, NumberLiteral, Identifier])
  },
  defaultMode: 'global'
};
