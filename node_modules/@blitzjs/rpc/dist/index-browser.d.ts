...
declare type InvalidateQueryTypeWithParams = <TInput, TResult, T extends AsyncFunc>(resolver: T | Resolver<TInput, TResult> | RpcClient<TInput, TResult>, ...params: [TInput]) => Promise<void>;
declare type InvalidateQueryTypeAllQueries = <TInput, TResult, T extends AsyncFunc>(resolver: T | Resolver<TInput, TResult> | RpcClient<TInput, TResult>) => Promise<void>;
declare type InvalidateQueryType = InvalidateQueryTypeWithParams & InvalidateQueryTypeAllQueries;
declare const invalidateQuery: InvalidateQueryType;
