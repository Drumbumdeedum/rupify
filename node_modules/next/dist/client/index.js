...
function renderReactElement(domEl, fn) {
    ...
    if (process.env.__NEXT_REACT_ROOT) {
        if (!reactRoot) {
            ...
            reactRoot = ReactDOM.hydrateRoot(domEl, reactEl, {onRecoverableError: (err) => (err.toString().includes("could not finish this Suspense boundary") || err.toString().includes("Minified React error #419")) ? null : console.error(err)});
